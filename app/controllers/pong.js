window.PongController = {

    index: function () {
    
        steroids.view.navigationBar.show("Simple Pong");
    
    },
        
    pong: function () {
    
        steroids.view.navigationBar.show("Pong");
        ...
        function startPong() {
            ...
            var canvas = document.getElementById("canvas"),
            		...
            		over = 0, // flag variable, cahnged when the game is over
            		init, // variable to initialize animation
            		paddleHit;
            
            // Add touchmove, click events to the canvas
